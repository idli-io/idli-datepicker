...
### Node Modules
- Run `npm install @idli/idli-datepicker --save`
- Put a script tag similar to this `<script src='node_modules/@idli/idli-datepicker/dist/idli-datepicker.js'></script>` in the head of your index.html
- Then you can use the element anywhere in your template, JSX, html etc

### In a stencil-starter app
- Run `npm install @idli/idli-datepicker --save`
- Add an import to the npm packages `import @idli/idli-datepicker;`
- Then you can use the element anywhere in your template, JSX, html etc
